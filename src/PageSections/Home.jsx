export default function Home() {
  return (
    <div
      className="w-full px-4 py-8 h-full slideup flex items-center text-colorTextB max-lg:flex-col max-lg:h-auto max-lg:px-2"
      id="Home">
      ...
      <div className="mx-auto w-[60%] text-center flex flex-col max-lg:w-[90%] text-colorTextB ">
        ...
        <p className="w-full text-[1.5rem] mt-[2rem] max-lg:text-[1rem] max-lg:mt-[1rem]">
          A Full Stack Developer, motivated towards learning and adapting to new
          technologies in the field of software engineering. I am fueled by a
          passion for leveraging the latest advancements to create impactful
